class ProductosController < ApplicationController
  ...
  def edit
    if current_user.name != @producto.creado_por
  ...
  def update
    respond_to do |format|
      if @producto.update(producto_params)
        format.html { redirect_to producto_url(@producto), notice: "El producto fue modificado exitosamente" }
  ...
  private
    ...
    def producto_params
      params.require(:producto).permit(:nombreProd, :precio, :stock, :creado_por)
    end
end
